...
if (!$installer->tableExists($installer->getTable('smtppro/email_attachment'))
		&& $installer->tableExists($installer->getTable('core/email_queue')))
{
	$table = $installer->getConnection()
	->newTable($installer->getTable('smtppro/email_attachment'))
	...
	$installer->getConnection()->addForeignKey(
	    $installer->getFkName('smtppro/email_attachment', 'message_id', 'core/email_queue', 'message_id'),
	    $installer->getTable('smtppro/email_attachment'),
	    'message_id',
